...
//////////////////////////////////////////////////////////////
void Discriminant_WHblessed(TString ntags = "two", TString ttbar_choice = "withtt")
{
  ...
  //Signal new TF(Ep,NNoutput)
  TChain* newsignal = new TChain("METree"); 
  char filenewsignal[500];
  sprintf(filenewsignal,"/cdf/disk02/g6/casal/WH/WH115.root"); 
  newsignal->Add(filenewsignal);
  cout<<filenewsignal<<endl;

  TChain* newbkg_tchannel = new TChain("METree"); 
  char filenewbkg_tchannel[500];
  sprintf(filenewbkg_tchannel,"/cdf/disk02/g6/casal/WH/tchan.root"); 
  newbkg_tchannel->Add(filenewbkg_tchannel);
  cout<<filenewbkg_tchannel<<endl;


  //Wbb  new TF(Ep,NNoutput)
  TChain* newbkg = new TChain("METree"); 
  char filenewbkg[600];
  sprintf(filenewbkg,"/cdf/disk02/g6/casal/WH/Wbottom.root");
  newbkg->Add(filenewbkg);
  cout<<filenewbkg<<endl;
  
  
  //schannel new TF(Ep,NNoutput)
  TChain* newbkg_schannel = new TChain("METree");
  char filenewbkg_schannel[500];
  sprintf(filenewbkg_schannel,"/cdf/disk02/g6/casal/WH/schan.root");    
  newbkg_schannel->Add(filenewbkg_schannel);
  cout<<filenewbkg_schannel<<endl;

  //ttbar
  TChain* newbkg_tt = new TChain("METree");
  char filenewbkg_tt[500];
  sprintf(filenewbkg_tt,"/cdf/disk02/g6/casal/WH/ttdil.root");    
  newbkg_tt->Add(filenewbkg_tt);
  cout<<filenewbkg_tt<<endl;

  TChain* newbkg_ttlj = new TChain("METree");
  char filenewbkg_ttlj[500];
  sprintf(filenewbkg_ttlj,"/cdf/disk02/g6/casal/WH/ttlj.root");    
  newbkg_ttlj->Add(filenewbkg_ttlj);
  cout<<filenewbkg_ttlj<<endl;
		         
  cout<<"Total Entries sg NEW TF          " <<newsignal->GetEntries()      <<endl;
  ...
  cout<<"Total Entries schannel bg NEW TF " <<newbkg_schannel->GetEntries()<<endl;
  cout<<"Total Entries tchannel bg NEW TF " <<newbkg_tchannel->GetEntries()<<endl;
  ...
  newbkg_tchannel_histo_nottbar->SetLineWidth(2);
  ...
  newbkg_schannel_histo_nottbar->SetLineWidth(2);
  ...
  newsignal_histo_nottbar->SetLineWidth(2);
  ...
  if( ntags == "one" ){
    ...
    newbkg_tt->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0001)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_tt_histo","((h.tagProb1*h.wgt*h.triggerTO))"); 

    
   
    newbkg_ttlj->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0001)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_ttlj_histo","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
  
    newbkg->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0001)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_histo","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
   
    newbkg_schannel->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0001)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_schannel_histo","((h.tagProb1*h.wgt*h.triggerTO))", "same");
    ...
    newsignal->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0001)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newsignal_histo","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 

    //*****************  No ttbar  **********************************************
    newbkg_tt->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_tt_histo_nottbar","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
  
   
    newbkg_ttlj->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_ttlj_histo_nottbar","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
  
    newbkg->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_histo_nottbar","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
   
    newbkg_schannel->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_schannel_histo_nottbar","((h.tagProb1*h.wgt*h.triggerTO))", "same");
    
    newbkg_tchannel->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newbkg_tchannel_histo_nottbar","((h.tagProb1*h.wgt*h.triggerTO))", "same");
    
    //WH
    newsignal->Draw("((bProb[0]*mnt.eventProb[14]*5000)/((bProb[0]*((mnt.eventProb[14]*5000)+(mnt.eventProb[0]*1.)+(mnt.eventProb[1]*0.5)+(mnt.eventProb[2]*0.1)+(mnt.eventProb[3]*3.63) + (mnt.eventProb[7]*0.0)))   + ((1-bProb[0])* ( (mnt.eventProb[3]*0.121) + (mnt.eventProb[4]*0.45) + (mnt.eventProb[5]*0) + (mnt.eventProb[6]*0.005)))      ))>>newsignal_histo_nottbar","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
  ...
  newbkg_tchannel_histo_2->SetLineWidth(2);
  ...
  newbkg_schannel_histo_2->SetLineWidth(2);
  ...
  newsignal_histo_2->SetLineWidth(2);

  if( ntags == "one" ){

    newbkg_tt->Draw("(epd1tagWH[1])>>newbkg_tt_histo_2","((h.tagProb1*h.wgt*h.triggerTO))"); 
    newbkg_schannel->Draw("(epd1tagWH[1])>>newbkg_schannel_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newbkg_ttlj->Draw("(epd1tagWH[1])>>newbkg_ttlj_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newbkg->Draw("(epd1tagWH[1])>>newbkg_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newbkg_tchannel->Draw("(epd1tagWH[1])>>newbkg_tchannel_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newsignal->Draw("(epd1tagWH[1])>>newsignal_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 

  }else if( ntags == "two" ){

    newbkg_tt->Draw("(epd2tagWH[1])>>newbkg_tt_histo_2","((h.tagProb1*h.wgt*h.triggerTO))"); 
    newbkg_schannel->Draw("(epd2tagWH[1])>>newbkg_schannel_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newbkg_ttlj->Draw("(epd2tagWH[1])>>newbkg_ttlj_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newbkg->Draw("(epd2tagWH[1])>>newbkg_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newbkg_tchannel->Draw("(epd2tagWH[1])>>newbkg_tchannel_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
    newsignal->Draw("(epd2tagWH[1])>>newsignal_histo_2","((h.tagProb1*h.wgt*h.triggerTO))", "same"); 
