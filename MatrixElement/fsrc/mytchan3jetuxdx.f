      SUBROUTINE MYTCHAN3JETUXDX(P1,MTOP,MW,ANS)
C  
...
C              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MMYTCHAN3JETUXDX(P1 ,MTOP, MW, NHEL(1,IHEL))            
                 ANS(1)=ANS(1)+T
...
C          CALL EXIT(1)
      ...
      REAL*8 FUNCTION MMYTCHAN3JETUXDX(P,MTOP, MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C      CALL FVIXXX(W(1,3   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
C      CALL JIOXXX(W(1,8   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,9   ))    
...
C      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
C      CALL JIOXXX(W(1,3   ),W(1,17  ),GWF ,WMASS   ,WWIDTH  ,W(1,18  ))    
C      CALL FVOXXX(W(1,7   ),W(1,18  ),GWF ,TMASS   ,TWIDTH  ,W(1,19  ))    
C      CALL IOVXXX(W(1,6   ),W(1,19  ),W(1,10  ),GWF ,AMP(4   ))            
      MMYTCHAN3JETUXDX = AMP(1) * DCONJG(AMP(1)) * 12
C
C      DO I = 1, NCOLOR
C          ZTEMP = (0.D0,0.D0)
C          DO J = 1, NCOLOR
