      SUBROUTINE MYSCHAN3JET2(P1,MTOP,MW,ANS)
C  
...
C      PRINT *,"Combining"
               T=MMYSCHAN3JET2(P1 ,MTOP, MW,NHEL(1,IHEL))            
C               IF (T . GT. 0D0) THEN
C               PRINT *, "HEL ", IHEL, T
C               ENDIF
               ANS(1)=ANS(1)+T
...
C      ENDDO
C          PRINT *, "ME element: ", ANS(1)
C          CALL EXIT(1)
      END
      
       
      REAL*8 FUNCTION MMYSCHAN3JET2(P,MTOP,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C      PRINT *, "P: ", P
      ...
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,11  ),GWF ,AMP(1   ))            

      CALL FVOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL JIOXXX(W(1,1   ),W(1,12  ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,13  ),GWF ,AMP(2   ))            

      CALL JIOXXX(W(1,1   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,14  ))    
      CALL FVIXXX(W(1,5   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL FVIXXX(W(1,15  ),W(1,8   ),GWF ,TMASS   ,TWIDTH  ,W(1,16  ))    
      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,14  ),GWF ,AMP(3   ))            

      CALL FVIXXX(W(1,9   ),W(1,14  ),GWF ,BMASS   ,ZERO    ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,7   ),GG ,AMP(4   ))             

      CALL FVIXXX(W(1,9   ),W(1,7   ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,14  ),GWF ,AMP(5   ))            
...
C      ENDDO
          DO J = 1, NCOLOR
             MMYSCHAN3JET2 =MMYSCHAN3JET2 + JAMP(J) * DCONJG(JAMP(J)) 
     .* 12
          ENDDO
C      Do I = 1, NGRAPHS
