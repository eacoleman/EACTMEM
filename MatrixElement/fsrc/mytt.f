      SUBROUTINE MYTT(P1,MTOP,MW,ANS)
C  
...
C      PRINT *," 1 P7(E,px,py,pz) ",P1(0,7),P1(1,7),P1(2,7),P1(3,7)
      ...
      ANS(1) = 0D0
      DO IHEL=1,NCOMB
        T=MMYTT(P1 ,MTOP,MW,NHEL(1,IHEL))		
        IF (T .GT. 0) THEN 
...
C      CALL EXIT(1)
      ...
      REAL*8 FUNCTION MMYTT(P,MTOP,MW,NHEL)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C       PRINT *," P6(E,px,py,pz) ",P(0,6),P(1,6),P(2,6),P(3,6)
      ...
      CALL FVOXXX(W(1,10  ),W(1,8   ),GG ,TMASS   ,TWIDTH  ,W(1,11  ))     
      CALL IOVXXX(W(1,6   ),W(1,11  ),W(1,7   ),GWF ,AMP(1   ))            
      JAMP(   1) = -AMP(   1)
      MMYTT = JAMP(1)*DCONJG(JAMP(1))*2.0d0
