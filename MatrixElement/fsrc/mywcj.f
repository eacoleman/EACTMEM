...
C      DO IHEL=1,NCOMB
      DO IHEL=1, 64
        T=MATRIX_WCJ(P1,MW,NHEL(1,IHEL))		
        IF (T .GT. 0) THEN 
        ANS(1)=ANS(1)+T
...
C      CALL EXIT(1)
      ...
      REAL*8 FUNCTION MATRIX_WCJ(P,MW,NHEL)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER ( NEXTERNAL= 6,NWAVEFUNCS=16)
C  
C ARGUMENTS 
C  
...
C       PRINT *," P1(E,px,py,pz) ",P(0,1),P(1,1),P(2,1),P(3,1)
      ...
      CALL IOVXXX(W(1,8   ),W(1,9   ),W(1,7   ),GWF ,AMP(1   ))            

C      PRINT *, "G ", G
      CALL JVVXXX(W(1,6   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,10  ))      
      CALL FVOXXX(W(1,1   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
      ...
      CALL IOVXXX(W(1,13  ),W(1,1   ),W(1,7   ),GWF ,AMP(4   ))            
      ...
      CALL FVOXXX(W(1,15  ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL IOVXXX(W(1,5   ),W(1,16  ),W(1,6   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,14  ),W(1,15  ),W(1,6   ),GG ,AMP(8   ))             

C      II = 2
C      DO II = 1,16
C      PRINT *, "W() ", II, W(1,II), W(2,II), W(3,II), W(4,II), W(5,II),
C     .W(6,II)
C      ENDDO
C      CALL EXIT(1)

C      DO II = 1,8
C         PRINT *, "AMP() ", II, AMP(II)
C      ENDDO
C      CALL EXIT(1)
...
C      CALL EXIT(1)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
C          PRINT *, "ZTEMP", ZTEMP
          MATRIX_WCJ =MATRIX_WCJ+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO

C      IF (MATRIX_WCJ .NE. 0) THEN
C      DO II = 1,8
C         PRINT *, "AMP() ", II, AMP(II)
C      ENDDO
C      PRINT *, "MATRIX_WCJ: ", MATRIX_WCJ
C      ENDIF
C      CALL EXIT(1)
