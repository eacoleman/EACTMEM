      SUBROUTINE MYWH2(P1,MTOP,MW,ANS)
C  
...
C      PRINT *," 1 P6(E,px,py,pz) ",P1(0,6),P1(1,6),P1(2,6),P1(3,6)
      ...
      ANS(1) = 0D0
      DO IHEL=1,NCOMB
        T=MMYWH2(P1 ,MTOP,MW,NHEL(1,IHEL))		
        IF (T .GT. 0) THEN 
...
C      PRINT *," ME2 for MTOP",ANS(1), MTOP
      ...
      REAL*8 FUNCTION MMYWH2(P,MTOP,MW,NHEL)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C      Two = 2.0d0 
      ...
      v   = 2.0d0*wmass*sw/ee   ! the wmass is used to calculate v
...
C       PRINT *," P6(E,px,py,pz) ",P(0,6),P(1,6),P(2,6),P(3,6)
      ...
      CALL HVVXXX(W(1,8   ),W(1,7   ),GWWH ,HMASS   ,HWIDTH  ,W(1,9   ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,6   ),W(1,9   ),GHBOT ,AMP(1   ))          
C      CALL FVOXXX(W(1,5   ),W(1,8   ),GWF ,TMASS   ,TWIDTH  ,W(1,9   ))    
C      CALL IOVXXX(W(1,6   ),W(1,9   ),W(1,7   ),GWF ,AMP(1   ))            
      MMYWH2 = AMP(1)*DCONJG(AMP(1))*9.0d0
