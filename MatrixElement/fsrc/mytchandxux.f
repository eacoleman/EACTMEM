      SUBROUTINE MYTCHANDXUX(P1,MTOP,MW,ANS)
C  
...
C      PRINT *," 1 P6(E,px,py,pz) ",P1(0,6),P1(1,6),P1(2,6),P1(3,6)
      ...
      ANS(1) = 0D0
      DO IHEL=1,NCOMB
        T=MMYTCHAN_DXUX(P1 ,MTOP,MW,NHEL(1,IHEL))		
        IF (T .GT. 0) THEN 
...
C      PRINT *," ME2 for MTOP",ANS(1), MTOP
      ...
      REAL*8 FUNCTION MMYTCHAN_DXUX(P,MTOP,MW,NHEL)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C       PRINT *," P6(E,px,py,pz) ",P(0,6),P(1,6),P(2,6),P(3,6)
      ...
      MMYTCHAN_DXUX = -AMP(1)*DCONJG(-AMP(1))*9.0d0
