      SUBROUTINE MYWH3JET2(P1,MH,MW,ANS)
C     Things I changed:
C     -change SMATRIX(P1,ANS) to MYWH3JET2(P1,MH,MW,ANS)
C     -change MATRIX(P,NHEL,IC) to  MMYWH3J2(P,MH,MW,NHEL)
...
C     ADDED ALL THESE LINES
      ...
      DO IHEL=1,NCOMB
        T= MMYWH3J2(P1 ,MH,MW,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
...
C      NN      ENDIF
C      NN      ANS(IPROC) = 0D0
C      NN      write(hel_buff,'(16i5)') (0,i=1,7)
...
C      NN              WRITE(HEL_BUFF,'(16i5)')(NHEL(i,IHEL),i=1,7)
C      NN          ENDIF
C      NN      ENDIF
C      NN      IF (MULTI_CHANNEL) THEN
C      NN          XTOT=0D0
...
C      NN      ENDDO
      ...
      REAL*8 FUNCTION MMYWH3J2(P,MH,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C BEGIN CODE
C ----------
      CALL OXXXXX(P(0,2   ),ZERO ,NHEL(1   ), -1, W(1,1   ))        
      CALL IXXXXX(P(0,1   ),ZERO ,NHEL(2   ), +1, W(1,2   ))        
      ...
      CALL JIOXXX(W(1,9   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL HVVHXX(W(1,7   ),W(1,10  ),GH ,HMASS   ,HWIDTH  ,W(1,11  ))     
      CALL IOSXXX(W(1,5   ),W(1,6   ),W(1,11  ),GHBOT ,AMP(1   ))          
C
      CALL FVOXXX(W(1,1   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      CALL JIOXXX(W(1,2   ),W(1,12  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL HVVHXX(W(1,7   ),W(1,13  ),GH ,HMASS   ,HWIDTH  ,W(1,14  ))     
      CALL IOSXXX(W(1,5   ),W(1,6   ),W(1,14  ),GHBOT ,AMP(2   ))          
C
      CALL FVOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,2   ),W(1,15  ),GWF ,WMASS   ,WWIDTH  ,W(1,16  ))    
      CALL HVVXXX(W(1,8   ),W(1,16  ),GWWH ,HMASS   ,HWIDTH  ,W(1,17))
      CALL IOSXXX(W(1,5   ),W(1,6   ),W(1,17  ),GHBOT ,AMP(3   ))          
C
      CALL FVIXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,18  ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,19  ))    
      CALL HVVXXX(W(1,8   ),W(1,19  ),GWWH ,HMASS   ,HWIDTH  ,W(1,20))
      CALL IOSXXX(W(1,5   ),W(1,6   ),W(1,20  ),GHBOT ,AMP(4   ))          
C
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,21 ))    
      CALL HVVXXX(W(1,8   ),W(1,21  ),GWWH ,HMASS   ,HWIDTH  ,W(1,22))
      CALL FVIXXX(W(1,5   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,23  ))     
      CALL IOSXXX(W(1,23  ),W(1,6   ),W(1,22  ),GHBOT ,AMP(5   ))          
C
      CALL FSIXXX(W(1,5   ),W(1,22  ),GHBOT ,BMASS   ,ZERO   ,W(1,24))                                 
      CALL IOVXXX(W(1,24  ),W(1,6   ),W(1,7   ),GG ,AMP(6   ))         
C    
      CALL JVSHXX(W(1,7   ),W(1,22  ),GH ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,25  ),GG ,AMP(7   ))             
...
C      JAMP(   2) = +AMP(   5)+AMP(   6)+AMP(   7)
      ...
      DO I = 1, NCOLOR
         ...
         ENDDO
         MMYWH3J2=MMYWH3J2+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
C      if (MMYWH3J2.GT.0) THEN
C        Do I = 1, 6
