      SUBROUTINE MYTCHAN3JETDXUX(P1,MTOP,MW,ANS)
C  
...
C              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MMYTCHAN3JETDXUX(P1 ,MTOP, MW, NHEL(1,IHEL))            
                 ANS(1)=ANS(1)+T
...
C          CALL EXIT(1)
      ...
      REAL*8 FUNCTION MMYTCHAN3JETDXUX(P,MTOP, MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C      CALL FVIXXX(W(1,7   ),W(1,9   ),GWF ,TMASS   ,TWIDTH  ,W(1,11  ))    
C      CALL IOVXXX(W(1,11  ),W(1,6   ),W(1,10  ),GWF ,AMP(1   ))            
      CALL JIOXXX(W(1,3   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL FVIXXX(W(1,7   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL FVIXXX(W(1,13  ),W(1,12  ),GWF ,TMASS   ,TWIDTH  ,W(1,14  ))    
      CALL IOVXXX(W(1,14  ),W(1,6   ),W(1,10  ),GWF ,AMP(1   ))            
C      CALL FVIXXX(W(1,7   ),W(1,12  ),GWF ,TMASS   ,TWIDTH  ,W(1,15  ))    
C      CALL FVIXXX(W(1,15  ),W(1,2   ),GG ,TMASS   ,TWIDTH  ,W(1,16  ))     
C      CALL IOVXXX(W(1,16  ),W(1,6   ),W(1,10  ),GWF ,AMP(3   ))            
C      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
C      CALL JIOXXX(W(1,17  ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,18  ))    
C      CALL FVIXXX(W(1,7   ),W(1,18  ),GWF ,TMASS   ,TWIDTH  ,W(1,19  ))    
C      CALL IOVXXX(W(1,19  ),W(1,6   ),W(1,10  ),GWF ,AMP(4   ))            
C      JAMP(   1) = 0D0
C      JAMP(   2) = -AMP(   1)
      MMYTCHAN3JETDXUX = AMP(1) * DCONJG(AMP(1)) * 12
C
C      DO I = 1, NCOLOR
C          ZTEMP = (0.D0,0.D0)
C          DO J = 1, NCOLOR
