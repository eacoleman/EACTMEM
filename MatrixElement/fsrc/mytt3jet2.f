      SUBROUTINE MYTT3JET2(P1,MTOP,MW,ANS)
C  
...
C      PRINT *,"Combining"
               T=MMYTT3JET2(P1 ,MTOP, MW,NHEL(1,IHEL))            
               ANS(1)=ANS(1)+T
...
C          CALL EXIT(1)
      ...
      REAL*8 FUNCTION MMYTT3JET2(P,MTOP,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C      PRINT *, "P: ", P
      ...
      CALL IXXXXX(P(0,8   ),ZERO ,NHEL(8   ),-1,W(1,8   ))        
      CALL JIOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL JIOXXX(W(1,4   ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,10  ))    
      CALL FVIXXX(W(1,5   ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,11  ))    
      CALL FVIXXX(W(1,11  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,12  ))     
      CALL JIOXXX(W(1,8   ),W(1,7   ),GWF ,WMASS   ,WWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,13  ),GWF ,AMP(1   ))            
...
C      PRINT *, "JAMP: ", JAMP
      MMYTT3JET2 = 6 * AMP(1) * DCONJG(AMP(1))
C      PRINT *, "mom"
C      DO I = 1, NCOLOR
C          ZTEMP = (0.D0,0.D0)
CC          PRINT *, "is"
...
C          ENDDO
CC          PRINT *, "a"
C          MMYTT3JET2 =MMYTT3JET2+ZTEMP*DCONJG(JAMP(I))/DENOM(I) 
CC          PRINT *, "FINAL: ",MMYTT3JET2
C      ENDDO
C          DO J = 1, NCOLOR
C             MMYTT3JET2 =MMYTT3JET2 + JAMP(J) * DCONJG(JAMP(J)) * 12
C          ENDDO
C      Do I = 1, NGRAPHS
