      SUBROUTINE MYWBB3JET2(P1,MW,ANS)
C  
...
C              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MMYWBB3JET2(P1 ,MW,NHEL(1,IHEL))            
                 ANS(1)=ANS(1)+T
...
C          CALL EXIT(0)
      ...
      REAL*8 FUNCTION MMYWBB3JET2(P,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      double precision  MW, wmass,bmass,wwidth,twidth
      double complex gwf(2), gg(2)

C      tmass   = MTOP  !top pole mass
...
C      call mytopwidth(tmass,wmass,wwidth,twidth)
...
C      PRINT *, "GWF GG WMASS BMASS WWIDTH:", GWF, GG, WMASS, BMASS,
C     .WWIDTH
C  
C GLOBAL VARIABLES
C  
...
C      PRINT *, "P:", P
      ...
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,14  ),GG ,AMP(2   ))             

      CALL FVIXXX(W(1,5   ),W(1,7   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL JIOXXX(W(1,10  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,16  ),GG ,AMP(3   ))             

      CALL FVIXXX(W(1,5   ),W(1,16  ),GG ,BMASS   ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,17  ),W(1,6   ),W(1,7   ),GG ,AMP(4   ))             

      CALL FVIXXX(W(1,10  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL JIOXXX(W(1,18  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,19  ),GG ,AMP(5   ))             

      CALL JVVXXX(W(1,7   ),W(1,16  ),G ,ZERO    ,ZERO    ,W(1,20  ))      
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,20  ),GG ,AMP(6   ))             

      CALL FVOXXX(W(1,9   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,21  ))    
      CALL JIOXXX(W(1,2   ),W(1,21  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,22  ),GG ,AMP(7   ))             

      CALL FVOXXX(W(1,1   ),W(1,8   ),GWF ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL JIOXXX(W(1,12  ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,24  ),GG ,AMP(8   ))             

      CALL JIOXXX(W(1,2   ),W(1,23  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,15  ),W(1,6   ),W(1,25  ),GG ,AMP(9   ))             

      CALL FVIXXX(W(1,5   ),W(1,25  ),GG ,BMASS   ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,26  ),W(1,6   ),W(1,7   ),GG ,AMP(10  ))             

      CALL FVOXXX(W(1,23  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL JIOXXX(W(1,2   ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,28  ),GG ,AMP(11  ))             

      CALL JVVXXX(W(1,7   ),W(1,25  ),G ,ZERO    ,ZERO    ,W(1,29  ))      
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,29  ),GG ,AMP(12  ))             
      JAMP(   1) = +AMP(   1)+AMP(   7)+AMP(  11)
      JAMP(   2) = +AMP(   2)+AMP(   5)+AMP(   8)
      JAMP(   3) = +AMP(   3)-AMP(   6)+AMP(   9)-AMP(  12)
      JAMP(   4) = +AMP(   4)+AMP(   6)+AMP(  10)+AMP(  12)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          MMYWBB3JET2 =MMYWBB3JET2+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
C      IF (MMYWBB3JET2 .GT. 0D0) THEN       
C      DO I = 1, NCOLOR
C          ZTEMP = (0.D0,0.D0)
C          DO J = 1, NCOLOR
C              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
C              PRINT *, "CF, JAMP ", CF(J, I), JAMP(J)
C          ENDDO
C          MMYWBB3JET =MMYWBB3JET+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
C      ENDDO
C      CALL EXIT(0)
C         PRINT *, "AMP: ", AMP
C      ENDIF
