...
C ----------
      ...
      ANS(1) = 0D0
      DO IHEL=1,NCOMB
        T=MATRIX_WCJ2(P1,MW,NHEL(1,IHEL))		
        IF (T .GT. 0) THEN 
        ANS(1)=ANS(1)+T
...
C      CALL EXIT(1)
      ...
      REAL*8 FUNCTION MATRIX_WCJ2(P,MW,NHEL)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,9   ))    
      ...
      CALL FVIXXX(W(1,15  ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          MATRIX_WCJ2 =MATRIX_WCJ2+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO

C      IF (MATRIX_WCJ2 .NE. 0) THEN
C      PRINT *, "MATRIX_WCJ2: ", MATRIX_WCJ2
C      DO II = 1,8
