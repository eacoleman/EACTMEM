      SUBROUTINE MYTCHANUXDX(P1,MTOP,MW,ANS)
C  
...
C      PRINT *," 1 P6(E,px,py,pz) ",P1(0,6),P1(1,6),P1(2,6),P1(3,6)
      ...
      ANS(1) = 0D0
      DO IHEL=1,NCOMB
        T=MMYTCHANUXDX(P1 ,MTOP,MW,NHEL(1,IHEL))		
C        IF (T .GT. 0) THEN 
C        ENDIF
C	  PRINT *,"IHEL, T ", IHEL,T
        ANS(1)=ANS(1)+T
C        PRINT *," ANS:",ANS(1), MTOP
      ENDDO
...
C      PRINT *," ME2 for MTOP",ANS(1), MTOP
      ...
      REAL*8 FUNCTION MMYTCHANUXDX(P,MTOP,MW,NHEL)
C  
C Generated by MadGraph II Version 3.0. Updated 02/19/04                
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C       PRINT *," P6(E,px,py,pz) ",P(0,6),P(1,6),P(2,6),P(3,6)
      ...
      CALL FVIXXX(W(1,5   ),W(1,7   ),GWF ,TMASS   ,TWIDTH  ,W(1,8   ))    
      CALL JIOXXX(W(1,6   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,9   ))    
      CALL IOVXXX(W(1,8   ),W(1,1   ),W(1,9   ),GWF ,AMP(1   ))  
C      PRINT *, "GWF, WMASS, WWIDTH, TMASS, TWIDTH:",GWF, WMASS, WWIDTH,
C     .TMASS, TWIDTH
C      PRINT *, "1",W(1,1), "2",W(1,2), "3",W(1,3), "4", W(1,4), "5",
C     .W(1,5), "6", W(1,6), "7", W(1,7), "8", W(1,8), "9", W(1,9)
C      PRINT *,"AMP: ", AMP(1)
      MMYTCHANUXDX = -AMP(1)*DCONJG(-AMP(1))*9.0d0
C      PRINT *,"MMYTCHANUXDX: ", MMYTCHANUXDX
