      SUBROUTINE WZlpuuM(P1,MZ,MW,ANS)
C  
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlpuu(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
CCC  Remove the IC
      ...
      CALL JIOXXX(W(1,1   ),W(1,8   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,9   ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,9   ),GZU ,AMP(1   ))            
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,10  ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,11  ),GZU ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL JVVXXX(W(1,12  ),W(1,7   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,13  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GZU ,AMP(3   ))
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          WZlpuu =WZlpuu+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WZlpuuAltM(P1,MZ,MW,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     ADDED ALL THESE LINES
      ...
      PRINT *,"STARTING NCOMB=",NCOMB
      DO IHEL=1,NCOMB
        T= WZlpuuAlt(P1 , MZ, MW,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
C        PRINT *,"IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= "
        IF (T .GT. 0) THEN 
           PRINT *," IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= ",
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlpuuAlt(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
CCC  Remove the IC
      ...
      CALL JIOXXX(W(1,8   ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,9   ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,9   ),GZU ,AMP(1   ))            
      CALL FVOXXX(W(1,1   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,2   ),W(1,10  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,11  ),GZU ,AMP(2   ))            
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WZlpuuAlt =WZlpuuAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WZlmuuM(P1,MZ,MW,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlmuu(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
CCC  Remove the IC
      ...
      CALL FVOXXX(W(1,2   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,8   ))    
      CALL JIOXXX(W(1,1   ),W(1,8   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,9   ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,9   ),GZU ,AMP(1   ))            
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,10  ),W(1,2   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,11  ),GZU ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL JVVXXX(W(1,7   ),W(1,12  ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,13  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GZU ,AMP(3   ))            
C      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WZlmuu =WZlmuu+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WZlmuuAltM(P1,MZ,MW,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     ADDED ALL THESE LINES
      ...
      PRINT *,"STARTING NCOMB=",NCOMB
      DO IHEL=1,NCOMB
        T= WZlmuuAlt(P1 , MZ, MW,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
C        PRINT *,"IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= "
        IF (T .GT. 0) THEN 
           PRINT *," IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= ",
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlmuuAlt(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
C  Remove the IC
      ...
      CALL JIOXXX(W(1,4   ),W(1,3   ),GWF ,WMASS   ,WWIDTH  ,W(1,7   ))    
      CALL FVIXXX(W(1,2   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,8   ))    
      CALL JIOXXX(W(1,8   ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,9   ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,9   ),GZU ,AMP(1   ))            
      CALL FVOXXX(W(1,1   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,2   ),W(1,10  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,11  ),GZU ,AMP(2   ))            
      CALL JIOXXX(W(1,2   ),W(1,1   ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL JVVXXX(W(1,7   ),W(1,12  ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,13  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GZU ,AMP(3   ))            
...
C      JAMP(   1) = -AMP(   1)
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WZlmuuAlt =WZlmuuAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WZlpddM(P1,MZ,MW,ANS)
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlpdd(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
CCC  Remove the IC
      ...
      CALL FVOXXX(W(1,2   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,8   ))    
      CALL JIOXXX(W(1,1   ),W(1,8   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,9   ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,9   ),GZD ,AMP(1   ))            
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWF ,ZERO    ,ZERO    ,W(1,10  ))    
      CALL JIOXXX(W(1,10  ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,11  ))    
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,11  ),GZD ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GWF ,WMASS   ,WWIDTH  ,W(1,12  ))    
      CALL JVVXXX(W(1,12  ),W(1,7   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,13  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,13  ),GZD ,AMP(3   ))            
      JAMP(   1) = -AMP(   1)-AMP(   2)-AMP(   3)
      WZlpdd = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WZlpdd =WZlpdd+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WZlpddAltM(P1,MZ,MW,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     ADDED ALL THESE LINES
      ...
      PRINT *,"STARTING NCOMB=",NCOMB
      DO IHEL=1,NCOMB
        T= WZlpddAlt(P1 , MZ, MW,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
C        PRINT *,"IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= "
        IF (T .GT. 0) THEN 
           PRINT *," IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= ",
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlpddAlt(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
CCC  Remove the IC
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WZlpddAlt =WZlpddAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WZlmddM(P1,MZ,MW,ANS)
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlmdd(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
CCC  Remove the IC
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WZlmdd =WZlmdd+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WZlmddAltM(P1,MZ,MW,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     ADDED ALL THESE LINES
      ...
      PRINT *,"STARTING NCOMB=",NCOMB
      DO IHEL=1,NCOMB
        T= WZlmddAlt(P1 , MZ, MW,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
C        PRINT *,"IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= "
        IF (T .GT. 0) THEN 
           PRINT *," IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= ",
...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION WZlmddAlt(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
C  Remove the IC
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WZlmddAlt =WZlmddAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
