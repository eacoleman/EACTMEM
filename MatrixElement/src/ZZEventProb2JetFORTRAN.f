...
C     
C     Process: b b~ > t t~ > e+ e- ve ve~ b b~ WEIGHTED=10
C     Process: b b~ > t t~ > e+ mu- ve vm~ b b~ WEIGHTED=10
C     Process: b b~ > t t~ > mu+ e- vm ve~ b b~ WEIGHTED=10
C     Process: b b~ > t t~ > mu+ mu- vm vm~ b b~ WEIGHTED=10
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL IXXXXX(P(0,8),MDL_MB,NHEL(8),-1*IC(8),W(1,8))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11,ZERO,ZERO,W(1,9))
      CALL FFV2_3(W(1,3),W(1,5),GC_100,MDL_MW,MDL_WW,W(1,2))
      CALL FFV2_3(W(1,6),W(1,4),GC_100,MDL_MW,MDL_WW,W(1,5))
      CALL FFV2_1(W(1,7),W(1,2),GC_100,MDL_MT,MDL_WT,W(1,6))
      CALL FFV2_2(W(1,8),W(1,5),GC_100,MDL_MT,MDL_WT,W(1,2))
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: g g > t t~ > e+ e- ve ve~ b b~ WEIGHTED=10
C     Process: g g > t t~ > e+ mu- ve vm~ b b~ WEIGHTED=10
C     Process: g g > t t~ > mu+ e- vm ve~ b b~ WEIGHTED=10
C     Process: g g > t t~ > mu+ mu- vm vm~ b b~ WEIGHTED=10
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3(W(1,3),W(1,5),GC_100,MDL_MW,MDL_WW,W(1,10))
      CALL FFV2_3(W(1,6),W(1,4),GC_100,MDL_MW,MDL_WW,W(1,5))
      CALL FFV2_1(W(1,7),W(1,10),GC_100,MDL_MT,MDL_WT,W(1,6))
      CALL FFV2_2(W(1,8),W(1,5),GC_100,MDL_MT,MDL_WT,W(1,10))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,10),W(1,6),W(1,9),GC_11,AMP(1))
      CALL FFV1_1(W(1,6),W(1,1),GC_11,MDL_MT,MDL_WT,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,9),W(1,2),GC_11,AMP(2))
      CALL FFV1_2(W(1,10),W(1,1),GC_11,MDL_MT,MDL_WT,W(1,9))
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > t t~ > e+ e- ve ve~ b b~ WEIGHTED=10
C     Process: u u~ > t t~ > e+ mu- ve vm~ b b~ WEIGHTED=10
C     Process: u u~ > t t~ > mu+ e- vm ve~ b b~ WEIGHTED=10
C     Process: u u~ > t t~ > mu+ mu- vm vm~ b b~ WEIGHTED=10
C     Process: c c~ > t t~ > e+ e- ve ve~ b b~ WEIGHTED=10
C     Process: c c~ > t t~ > e+ mu- ve vm~ b b~ WEIGHTED=10
C     Process: c c~ > t t~ > mu+ e- vm ve~ b b~ WEIGHTED=10
C     Process: c c~ > t t~ > mu+ mu- vm vm~ b b~ WEIGHTED=10
C     Process: d d~ > t t~ > e+ e- ve ve~ b b~ WEIGHTED=10
C     Process: d d~ > t t~ > e+ mu- ve vm~ b b~ WEIGHTED=10
C     Process: d d~ > t t~ > mu+ e- vm ve~ b b~ WEIGHTED=10
C     Process: d d~ > t t~ > mu+ mu- vm vm~ b b~ WEIGHTED=10
C     Process: s s~ > t t~ > e+ e- ve ve~ b b~ WEIGHTED=10
C     Process: s s~ > t t~ > e+ mu- ve vm~ b b~ WEIGHTED=10
C     Process: s s~ > t t~ > mu+ e- vm ve~ b b~ WEIGHTED=10
C     Process: s s~ > t t~ > mu+ mu- vm vm~ b b~ WEIGHTED=10
C     
      IMPLICIT NONE
C     
C     CONSTANTS
