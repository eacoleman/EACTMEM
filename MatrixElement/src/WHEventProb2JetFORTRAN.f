      SUBROUTINE WHlpM(P1,HMASS,HWIDTH,ANS)
C  
...
C  
      ...
      REAL*8 T, P(0:3,6)
CNN      REAL*8 MATRIX
C Include the new variables (&rename one)
      REAL*8 HWIDTH
      REAL*8 HMASS
      REAL*8 WHlp
...
C     ADDED ALL THESE LINES
      ...
      DO IHEL=1,NCOMB
        T= WHlp(P1 , HMASS, HWIDTH,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
...
C   NN      ENDDO
      ...
      REAL*8 FUNCTION WHlp(P,HMASS,HWIDTH,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  Remove the IC
      ...
      CALL HVVXXX(W(1,7   ),W(1,8   ),GWWH ,HMASS   ,HWIDTH  ,W(1,         
     &     9   ))                                                          
      CALL IOSXXX(W(1,6   ),W(1,5   ),W(1,9   ),GHBOT ,AMP(1   ))          
      JAMP(   1) = -AMP(   1)
      WHlp = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          WHlp =WHlp+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WHlmM(P1,HMASS,HWIDTH,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     ADDED ALL THESE LINES
      ...
      PRINT *,"STARTING NCOMB=",NCOMB
      DO IHEL=1,NCOMB
        T= WHlm(P1 , HMASS, HWIDTH,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
C        PRINT *,"IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= "
        IF (T .GT. 0) THEN 
           PRINT *," IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= ",
...
C NN      ENDDO
      ...
      REAL*8 FUNCTION WHlm(P,HMASS,HWIDTH,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
C  Remove the IC
      ...
      CALL HVVXXX(W(1,8   ),W(1,7   ),GWWH ,HMASS   ,HWIDTH  ,W(1,         
     &     9   ))                                                          
      CALL IOSXXX(W(1,6   ),W(1,5   ),W(1,9   ),GHBOT ,AMP(1   ))          
      JAMP(   1) = +AMP(   1)
      WHlm = 0.D0 
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WHlm =WHlm+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WHlpAltM(P1,HMASS,HWIDTH,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     ADDED ALL THESE LINES
      ...
      PRINT *,"STARTING NCOMB=",NCOMB
      DO IHEL=1,NCOMB
        T= WHlpAlt(P1 , HMASS, HWIDTH,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
C        PRINT *,"IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= "
        IF (T .GT. 0) THEN 
           PRINT *," IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= ",
...
C NN      ENDDO
      ...
      REAL*8 FUNCTION WHlpAlt(P,HMASS,HWIDTH,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
     ...
     &     9   ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WHlpAlt =WHlpAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE WHlmAltM(P1,HMASS,HWIDTH,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C     ADDED ALL THESE LINES
      ...
      PRINT *,"STARTING NCOMB=",NCOMB
      DO IHEL=1,NCOMB
        T= WHlmAlt(P1 , HMASS, HWIDTH,NHEL(1,IHEL))		
        ANS(1)=ANS(1)+T
C        PRINT *,"IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= "
        IF (T .GT. 0) THEN 
           PRINT *," IHEL= ", IHEL," T= ",T," ME=",ANS(1)," IDEN(1)= ",
...
C NN      ENDDO
      ...
      REAL*8 FUNCTION WHlmAlt(P,HMASS,HWIDTH,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
     ...
     &     9   ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          WHlmAlt =WHlmAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
