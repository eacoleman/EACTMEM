...
EventProb* MEJobForCrab::sm_eventProb(0);


//-----------------------------------------------------------------------------
MEJobForCrab::MEJobForCrab(EventFile& inputFile, const std::string& outputFilename) :
...
//-----------------------------------------------------------------------------
void MEJobForCrab::addEventProb(EventProb& prob, unsigned jetBin)
{
...
void MEJobForCrab::loopOverEvents()
{
  // Set the tree
...
void MEJobForCrab::massScan(float low, float high, unsigned steps, 
		     std::string process){
...
void MEJobForCrab::m_setTopMass(double mass){
...
void MEJobForCrab::m_setHiggsMass(double mass){
...
void MEJobForCrab::m_reportInputValues(const PartonColl& partons){
...
void MEJobForCrab::m_doEvent(PartonColl& partons){
...
//-----------------------------------------------------------------------------
void MEJobForCrab::sm_integrand(const int*, const double params[],
...
void MEJobForCrab::sm_peakFinder(const int* nDim, const double bounds[], int* nPoints,
                          double peaks[]){
