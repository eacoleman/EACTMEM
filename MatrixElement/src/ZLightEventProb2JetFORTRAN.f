...
C     NN      ENDDO
      ...
      REAL*8 FUNCTION Zug(P,MZ,MW,NHEL)       
...
C  Remove the IC
      ...
      CALL VVVXXX(W(1,6   ),W(1,1   ),W(1,14  ),SGG ,AMP(5   ))              
...
C      print *, "Amp1=", AMP(1)
CC      print *, "W(1,3) = ", W(1,3) , "W(2,3) = " , W(2,3)
CC      print *, "W(3,3) = ", W(3,3) , "W(4,3) = " , W(4,3)
C      print 10,"W(1-2,3)=", W(1,3), W(2,3)
C 10   format (1X,A10,"[(",F6.2,",",F6.2,")","(",F6.2,",",F6.2,")]")
C      print 20,"W(3-4,3)=", W(3,3), W(4,3)
C 20   format (1X,A10,"[(",F6.2,",",F6.2,")","(",F6.2,",",F6.2,")]")
CC      print 10,"W(1-4,1)=", W(1,1), W(2,1), W(3,1), W(4,1)
CC      print 10,"W(1-4,2)=", W(1,2), W(2,2), W(3,2), W(4,2)
CC      print 10,"W(1-4,3)=", W(1,3), W(2,3), W(3,3), W(4,3)
CC      print 10,"W(1-4,4)=", W(1,4), W(2,4), W(3,4), W(4,4)
CC      print 10,"W(1-4,5)=", W(1,5), W(2,5), W(3,5), W(4,5)
CC      print 10,"W(1-4,6)=", W(1,6), W(2,6), W(3,6), W(4,6)

CC      print 10,"W(1-4,7)=", W(1,7), W(2,7), W(3,7), W(4,7)
CC      print 10,"W(1-4,10)=", W(1,10), W(2,10), W(3,10), W(4,10)
CC 10   format (1X,A10,"[(",2F6.2,")(",2F6.2,")(",2F6.2,")(",2F6.2,")]")




CCC10    format (1X,A8,"(",E8.2,",",E8.2,")")
CCC10    format (1X,A10,"[(",F5.2,",",F5.2,")","(",F5.2,",",F5.2,")", &
CCC      & "(",F5.2,",",F5.2,")","(",F5.2,",",F5.2,")]")
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          Zug =Zug+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
...
CCC ---------------------------------------------------------------------------------------------------------------
         ...
         SUBROUTINE ZugAltM(P1,MZ,MW,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C NN      ENDDO
      ...
      REAL*8 FUNCTION ZugAlt(P,MZ,MW,NHEL)
...
C  Remove the IC
      ...
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,11  ),SGG ,AMP(2   ))              
      ...
      CALL VVVXXX(W(1,6   ),W(1,2   ),W(1,15  ),SGG ,AMP(6   ))              
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          ZugAlt =ZugAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
C NN      ENDDO
      ...
      REAL*8 FUNCTION Zdg(P,MZ,MW,NHEL)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT WITH EXTERNAL LINES W(0:6,6)
...
C  Remove the IC
      ...
      CALL IOVXXX(W(1,2   ),W(1,15  ),W(1,6   ),GG ,AMP(6   ))             
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL FVIXXX(W(1,16  ),W(1,7   ),GZD ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,5   ),W(1,6   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,16  ),W(1,13  ),W(1,6   ),GG ,AMP(8   ))             
      JAMP(   1) = -AMP(   1)+AMP(   2)+AMP(   4)-AMP(   5)+AMP(   6)
      JAMP(   2) = +AMP(   1)+AMP(   3)+AMP(   5)+AMP(   7)+AMP(   8)
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          Zdg =Zdg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
...
CCC ---------------------------------------------------------------------------------------------------------------
      ...
      SUBROUTINE ZdgAltM(P1,MZ,MW,ANS)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C AND HELICITIES
...
C NN      ENDDO
      ...
      REAL*8 FUNCTION ZdgAlt(P,MZ,MW,NHEL)
...
C  Remove the IC
      ...
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZL ,ZMASS   ,ZWIDTH  ,W(1,7   ))    
      CALL FVOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL FVOXXX(W(1,8   ),W(1,7   ),GZD ,ZERO    ,ZERO    ,W(1,9   ))    
      CALL IOVXXX(W(1,1   ),W(1,9   ),W(1,6   ),GG ,AMP(1   ))             
      ...
      DO I = 1, NCOLOR
          ...
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          ZdgAlt =ZdgAlt+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
          amp2(i)=amp2(i)+amp(i)*dconjg(amp(i))
      Enddo
