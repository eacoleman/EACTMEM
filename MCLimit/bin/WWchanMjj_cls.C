...
int main(int argc, char **argv)
{
  ...
  //TString dirPath="/uscms_edata/d1/ilyao/MEResults/PAT356FullScan/MCLimit/";
...
//   histZZ->Scale(scale_ZZ);
  ...
  inputstr=dirPath+"STopT_MjjHistFile.root";
  ...
  inputstr=dirPath+"STopS_MjjHistFile.root";
...
//   TFile *infileSTopTW = (TFile*) new TFile("STopTW_MjjHistFile.root");
...
//   histSTopTW->Scale(scale_STopTW);
  ...
  inputstr=dirPath+"QCDOnlyElData_MjjHistFile.root";
  ...
  inputstr=dirPath+"QCDOnlyMuData_MjjHistFile.root";
  ...
  inputstr=dirPath+"DataElandMu_MjjHistFile.root";
