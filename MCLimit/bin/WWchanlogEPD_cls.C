...
//   histSTopTW->Scale(scale_STopTW);
  ...
  inputstr=dirPath+"QCDOnlyElData_logEPDWWandWZHistFile.root";
  ...
  inputstr=dirPath+"QCDOnlyMuData_logEPDWWandWZHistFile.root";
  ...
  inputstr=dirPath+"DataElandMu_logEPDWWandWZHistFile.root";
