...
//   histZZ->Scale(scale_ZZ);
  ...
  inputstr=dirPath+"STopT_EPDWWandWZHistFile.root";
  ...
  inputstr=dirPath+"STopS_EPDWWandWZHistFile.root";
...
//   TFile *infileSTopTW = (TFile*) new TFile("STopTW_EPDWWandWZHistFile.root");
