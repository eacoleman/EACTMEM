...
int main(int argc, char **argv)
{
  ...
  TFile *infileWW = (TFile*)new TFile("PATTuples355/Results/WW_MjjHistFile.root");
  histWW  = (TH1F*)infileWW->Get("EvtHist;1")->Clone("WWcent");
  histWW->Scale(scale_WW);
  TFile *infileWZ = (TFile*)new TFile("PATTuples355/Results/WZ_MjjHistFile.root");
  histWZ  = (TH1F*)infileWZ->Get("EvtHist;1")->Clone("WZcent");
  histWZ->Scale(scale_WZ);


  TFile *infileWpJ = (TFile*) new TFile("PATTuples355/Results/WpJ_MjjHistFile.root");
  histWpJ  = (TH1F*)infileWpJ->Get("EvtHist;1")->Clone("WpJcent");
  histWpJ->Scale(scale_WpJ);
  TFile *infileZpJ = (TFile*) new TFile("PATTuples355/Results/ZpJ_MjjHistFile.root");
  histZpJ  = (TH1F*)infileZpJ->Get("EvtHist;1")->Clone("ZpJcent");
  histZpJ->Scale(scale_ZpJ);
  TFile *infileZZ = (TFile*) new TFile("PATTuples355/Results/ZZ_MjjHistFile.root");
  histZZ  = (TH1F*)infileZZ->Get("EvtHist;1")->Clone("ZZcent");
  histZZ->Scale(scale_ZZ);
  TFile *infileTTbar = (TFile*) new TFile("PATTuples355/Results/TTbar_MjjHistFile.root");
  histTTbar  = (TH1F*)infileTTbar->Get("EvtHist;1")->Clone("TTbarcent");
  histTTbar->Scale(scale_TTbar);
  TFile *infileSTopT = (TFile*) new TFile("PATTuples355/Results/STopT_MjjHistFile.root");
  histSTopT  = (TH1F*)infileSTopT->Get("EvtHist;1")->Clone("STopTcent");
  histSTopT->Scale(scale_STopT);
  TFile *infileSTopS = (TFile*) new TFile("PATTuples355/Results/STopS_MjjHistFile.root");
  histSTopS  = (TH1F*)infileSTopS->Get("EvtHist;1")->Clone("STopScent");
  histSTopS->Scale(scale_STopS);
  TFile *infileSTopTW = (TFile*) new TFile("PATTuples355/Results/STopTW_MjjHistFile.root");
  ...
  TFile *infileQCDHT100to250 = (TFile*) new TFile("PATTuples355/Results/QCDHT100to250_NoIsoCut_MjjHistFile.root");
  ...
  TFile *infileQCDHT250to500 = (TFile*) new TFile("PATTuples355/Results/QCDHT250to500_NoIsoCut_MjjHistFile.root");
  ...
  ////////////////////////////***** Compute The Limits *****//////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////////////////////
  int npx=2000;//number of PE
  int nPE=100;//number of points per PE
...
//   cout << "CLs +2sigma (sig): " << mymclimit->clsexpsp2() << endl;
  ...
  mymclimit->bayes_heinrich_withexpect(bh,&sflimit,&unc,npx,&sm2,&sm1,&smed,&sp1,&sp2);
  //mymclimit->bayes_heinrich(bh,&sflimit,&unc);
  std::cout << "END_PE" << std::endl;
  std::cout << "Expected Limit at: " << bh <<" % C.L "<< smed << " Full band: -2SD -1SD MPV +1SD +2SD " << sm2 << " " << sm1 << " " << smed << " " << sp1 << " " << sp2 << std::endl; 
