...
//   ClassDef(DumbClassToTrickRoot2, 1)
...
public:
  ...
  EventNtuple(); // I HATE ROOT!
//   EventNtuple(int nJets);
//   EventNtuple(const EventNtuple&);
//   EventNtuple& operator=(const EventNtuple&);
  ~EventNtuple();
