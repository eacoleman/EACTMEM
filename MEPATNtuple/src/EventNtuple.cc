...
// EventNtuple::EventNtuple(int ijets) :
//    nJets(ijets)
// {
...
// EventNtuple::EventNtuple(const EventNtuple& rhs)
// {
//    nJets = rhs.nJets;
...
// EventNtuple& EventNtuple::operator=(const EventNtuple& rhs)
// {
//    nJets = rhs.nJets;
...
// Double_t EventNtuple::getKNNTagProb(double knn)
// {
...
// Double_t EventNtuple::calcEPD(unsigned ntag, EPDType type) const {
...
// //------------------------------------------------------------------------------
// const double * EventNtuple::getSingleTopEPDCoefficients (unsigned ntag, EPDType type){
...
// //------------------------------------------------------------------------------
// //EPD for single top 
// Double_t EventNtuple::calcEPD(unsigned ntag, EPDType type,
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcHiggsEPD(unsigned ntag, double mass) const
// {
//   if(ntag==0)
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcHiggsEPD(unsigned ntag, double mass,
//                                    const double eventProb[nEventProb],
//                                    const double bProb[], Int_t nJets){
...
// //------------------------------------------------------------------------------
// unsigned int EventNtuple::getHiggsMassIndex(double mass){
...
//   //fail with error
//   throw std::runtime_error("EventNtuple::getHiggsMassIndex wrong mass requested");
//   return 0;

// }//getHiggsMassIndex

// //------------------------------------------------------------------------------
// const double * EventNtuple::getHiggsEPDCoefficients(int indexWH, unsigned ntag, int nJets){
...
//       tagIndex = 1;
//    else{
//       throw std::runtime_error("ERROR EventNtuple::getHiggsEPDCoefficients. Invalid tag requested");
//    }

//    // Only allow 2 and 3 jets for now
//    if (nJets != 2 && nJets != 3 )
//      throw std::runtime_error("ERROR EventNtuple::getHiggsEPDCoefficients. Invalid nJets requested");
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcHiggsMaxProbEPD(unsigned ntag, double mass) const
// {
//   if(ntag==0)
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcHiggsMaxProbEPD(unsigned ntag, double mass,
...
// //------------------------------------------------------------------------------
// const double * EventNtuple::getHiggsEPDMaxProbCoefficients(int indexWH, unsigned ntag){
...
//       tagIndex = 1;
//    else{
//       throw std::runtime_error("ERROR EventNtuple::getHiggsEPDMaxProbCoefficients. Invalid tag requested");
//    }
...
// //------------------------------------------------------------------------------
// ProbsForEPD EventNtuple::getProbsForEPD(const double eventProb[nEventProb], 
...
//    {
//      if (bProb[0] < 0){
//        //cout<<" ERROR EventNtuple::getProbsForEPD has ntag==1 and bProb0<0"<<endl;
...
//        //cout<<" ERROR EventNtuple::getProbsForEPD has ntag==2 and (bProb[0]<0 || bProb[1]<0)"<<endl;
//        //send to cero the numerator of the EPDs that you want to get
//        probs.wh     *= 0;
//        probs.schan  *= 0;
//        probs.tchan  *= 0;
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcHiggsSuperEPD(unsigned ntag, double mass) const
// {
//   if(ntag==0)
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcHiggsSuperEPD(unsigned ntag, double mass,
// 					const double eventProb[nEventProb],
// 					const double bProb[], Int_t nJets){
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcWZEPD(unsigned ntag, unsigned secvtxtag) const
// {
//   if(ntag==0)
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::calcWZEPD(unsigned ntag, unsigned secvtxtag,
//                                    const double eventProb[nEventProb],
//                                    const double bProb[], Int_t nJets){
...
//       tagIndex = 1;
//    else{
//       throw std::runtime_error("ERROR EventNtuple::calcWZEPD. Invalid tag requested");
//    }
...
// //------------------------------------------------------------------------------
// Double_t EventNtuple::eventDump(const DumbClassToTrickRoot* h, double epd,
...
// Bool_t EventNtuple::cutEvents() const
// {
...
// Double_t EventNtuple::triggerTO(double detector, double etalep, double metraw,
//                                 double etlep)
// {
...
// DumbClassToTrickRoot2::DumbClassToTrickRoot2()
// {
//   //   clear();
// }
...
//  ClassImp(DumbClassToTrickRoot2)
