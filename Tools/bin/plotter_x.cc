...
int main(int argc,char**argv) {
   ...
   double         intLum            = cl.getValue<double>  ("lum",           5020);  
...
vector<PhysicsProcessNEW*> getProcesses(DEFS::LeptonCat leptonCat, double intLum){
  ...
  string basePath = "/uscms/home/aperloff/nobackup/Spring12ME7TeV/MEResults/microNtuples_oldStructure/";
  vector <PhysicsProcessNEW*> procs;
  
  procs.push_back(new PlotterPhysicsProcessNEW("WW",basePath+"microWW_EPDv01.root", getCrossSection("WW"),
                                               intLum, getNumMCEvts("WW"), getProcessColor("WW"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("WZ",basePath+"microWZ_EPDv01.root", getCrossSection("WZ"),
                                               intLum, getNumMCEvts("WZ"), getProcessColor("WZ"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("DYJets",basePath+"microDYJets_EPDv01.root", getCrossSection("DYJets"),
                                               intLum, getNumMCEvts("DYJets"), getProcessColor("DYJets"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("TTbar",basePath+"microTTbar_EPDv01.root", getCrossSection("TTbar"),
                                               intLum, getNumMCEvts("TTbar"), getProcessColor("TTbar"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("STopT_T",basePath+"microSTopT_T_EPDv01.root", getCrossSection("STopT_T"),
                                               intLum, getNumMCEvts("STopT_T"), getProcessColor("STopT_T"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("STopT_Tbar",basePath+"microSTopT_Tbar_EPDv01.root",
                                               getCrossSection("STopT_Tbar"), intLum, getNumMCEvts("STopT_Tbar"),
                                               getProcessColor("STopT_Tbar"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("STopS_T",basePath+"microSTopS_T_EPDv01.root", getCrossSection("STopS_T"),
                                               intLum, getNumMCEvts("STopS_T"), getProcessColor("STopS_T"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("STopS_Tbar",basePath+"microSTopS_Tbar_EPDv01.root",
                                               getCrossSection("STopS_Tbar"), intLum, getNumMCEvts("STopS_Tbar"),
                                               getProcessColor("STopS_Tbar"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("STopTW_T",basePath+"microSTopTW_T_EPDv01.root",
                                               getCrossSection("STopTW_T"), intLum, getNumMCEvts("STopTW_T"),
                                               getProcessColor("STopTW_T"),"METree"));
  procs.push_back(new PlotterPhysicsProcessNEW("STopTW_Tbar",basePath+"microSTopTW_Tbar_EPDv01.root", 
                                               getCrossSection("STopTW_Tbar"), intLum, getNumMCEvts("STopTW_Tbar"),
                                               getProcessColor("STopTW_Tbar"),"METree"));
  // procs.push_back(new PlotterPhysicsProcessNEW("ggH125",basePath+"microggH125_EPDv01.root", 
  //                                              getCrossSection("ggH125")*getBranchingRatio("ggH125"),
  //                                              intLum, getNumMCEvts("ggH125"), getProcessColor("ggH125"), 
  //                                              "METree"));
  // procs.push_back(new PlotterPhysicsProcessNEW("qqH125",basePath+"microqqH125_EPDv01.root", 
  ...
  if (leptonCat == DEFS::electron || leptonCat == DEFS::both){
     procs.push_back(new PlotterPhysicsProcessNEW("WJets_electron",basePath+"microWJets_EPDv01.root",
                                                  /*0.43844*/0.815078*0.99546*getCrossSection("WJets"), intLum, getNumMCEvts("WJets"),
                                                  getProcessColor("WJets"), "METree", DEFS::electron));
/*
    procs.push_back(new PlotterPhysicsProcessNEW("WJets_electron",basePath+"microWJets_matchingup_EPDv01.root",0.815078*getCrossSection("WJets"),
                                                  intLum, getNumMCEvts("WJets"), getProcessColor("WJets"),
                                                  "METree", DEFS::electron));
*/
    procs.push_back(new PlotterPhysicsProcessNEW("Data_electron",basePath+"microSingleEl_Data_EPDv01.root",
                                                 1./intLum, intLum, 1,
                                                 getProcessColor("SingleEl_Data"),
                                                 "METree", DEFS::electron));
    procs.push_back(new PlotterPhysicsProcessNEW("QCD_electronEnriched", basePath+"microQCD_ElEnriched_EPDv01.root",
                                                 /*0.00439695*/0.00136091*0.996063*getCrossSection("QCD_ElEnriched"), intLum,
                                                 getNumMCEvts("QCD_ElEnriched"),
                                                 getProcessColor("QCD_ElEnriched"),
                                                 "METree", DEFS::electron));
/*
    procs.push_back(new PlotterPhysicsProcessNEW("QCD_ElEnriched", basePath+"microQCD_ElEnriched_EPDv01.root",
                                                 1, intLum*0.0663, 205,
                                                 getProcessColor("QCD_ElEnriched"),
                                                 "METree", DEFS::electron));
*/
  ...
  if (leptonCat == DEFS::muon || leptonCat == DEFS::both){
     procs.push_back(new PlotterPhysicsProcessNEW("WJets_muon",basePath+"microWJets_EPDv01.root",
                                                  /*0.775792*/0.889803*0.995544*getCrossSection("WJets"), intLum, getNumMCEvts("WJets"),
                                                  getProcessColor("WJets"), "METree", DEFS::muon));
/*
    procs.push_back(new PlotterPhysicsProcessNEW("WJets_muon",basePath+"microWJets_matchingup_EPDv01.root",0.889803*getCrossSection("WJets"),
                                                 intLum, getNumMCEvts("WJets"), getProcessColor("WJets"),
                                                 "METree", DEFS::muon));
*/
    procs.push_back(new PlotterPhysicsProcessNEW("Data_muon",basePath+"microSingleMu_Data_EPDv01.root",
                                                 1./intLum, intLum, 1,
                                                 getProcessColor("SingleMu_Data"),
                                                 "METree", DEFS::muon));
    procs.push_back(new PlotterPhysicsProcessNEW("QCD_muonEnriched", basePath+"microQCD_MuEnriched_EPDv01.root",
                                                 /*0.000853197*/0.000034723*0.984128*getCrossSection("QCD_MuEnriched"), intLum,
                                                 getNumMCEvts("QCD_MuEnriched"),
                                                 getProcessColor("QCD_MuEnriched"),
                                                 "METree", DEFS::muon));
/*
    procs.push_back(new PlotterPhysicsProcessNEW("QCD_MuEnriched", basePath+"microQCD_MuEnriched_EPDv01.root",
                                                 1, intLum*0.001625, 611,
                                                 getProcessColor("QCD_MuEnriched"),
                                                 "METree", DEFS::muon));
*/
  }
...
vector<PhysicsProcessNEW*> getProcesses(vector<string>& processNames, DEFS::LeptonCat leptonCat, double intLum){
  ...
  //  string basePath = "/uscms_data/d3/ilyao/Summer11/428Full/Stage2SkimResults/"; 
   string basePath = "/uscms/home/aperloff/nobackup/Spring12ME7TeV/MEInput_oldStructure/"; //602 to 613
   vector <PhysicsProcessNEW*> procs;
      ...
      if (TString(processNames[i]).Contains("Data")==1) {
         ...
         if (leptonCat == DEFS::electron || leptonCat == DEFS::both)
            procs.push_back(new PlotterPhysicsProcessNEW("WJets_electron",basePath+processNames[i]+".root",
                                                         0.815078*getCrossSection(processNames[i]), intLum, getNumMCEvts(processNames[i]),
                                                         getProcessColor(processNames[i]),
                                                         "PS/EvtTree",DEFS::electron));
         if (leptonCat == DEFS::muon || leptonCat == DEFS::both)
            procs.push_back(new PlotterPhysicsProcessNEW("WJets_muon",basePath+processNames[i]+".root",
                                                         0.889803*getCrossSection(processNames[i]), intLum, getNumMCEvts(processNames[i]),
                                                         getProcessColor(processNames[i]),
                                                         "PS/EvtTree",DEFS::muon));
      }
         ...
         if (leptonCat == DEFS::electron || leptonCat == DEFS::both)
            procs.push_back(new PlotterPhysicsProcessNEW("QCD_ElEnriched", basePath+"QCD_ElEnriched.root",
                                                         0.00136091*getCrossSection("QCD_ElEnriched"), intLum,
                                                         getNumMCEvts("QCD_ElEnriched"),
                                                         getProcessColor("QCD_ElEnriched"),
                                                         "PS/EvtTree", DEFS::electron));
         if (leptonCat == DEFS::muon || leptonCat == DEFS::both)
            procs.push_back(new PlotterPhysicsProcessNEW("QCD_MuEnriched", basePath+"QCD_MuEnriched.root",
                                                         0.000034723*getCrossSection("QCD_MuEnriched"), intLum,
                                                         getNumMCEvts("QCD_MuEnriched"),
                                                         getProcessColor("QCD_MuEnriched"),
                                                         "PS/EvtTree", DEFS::muon));
      }
...
map<string, Plot*> getPlots(string leptonCatString, bool norm_data){
   ...
   double signalFactor = 10;
   TString signalName = "WW+WZ";
