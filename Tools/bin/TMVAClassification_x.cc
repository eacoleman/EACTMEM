...
int main(int argc, char**argv) {
   ...
   vector<TString> ifilesSignal     = cl.getVector<TString> ("ifilesSignal",                            "HWWMH150");
   vector<TString> ifilesBackground = cl.getVector<TString> ("ifilesBackground", "WW:::WZ:::WJets:::ZJets:::TTbar");
